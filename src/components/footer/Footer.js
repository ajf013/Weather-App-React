...
function Footer({ onResetLocationPermission }) {
  return (
    <div data-aos="fade-up" className="footer_main">
      ...
      <div className="footer_controls" style={{ textAlign: 'center', marginBottom: '15px' }}>
        <button 
          className="reset-location-btn" 
          onClick={onResetLocationPermission}
          title="Reset your location permission choice"
        >
          <Icon name="map pin" /> Reset Location Permission
        </button>
      </div>
